...
export type ScheduledOperationAffectedDocument = Asset | Subscriber;
...
export type GetSubscriberQuery = { __typename?: 'Query', subscribers: Array<{ __typename?: 'Subscriber', name: string, email: string, phone: string, message: string, createdAt: any }> };


export const CreateSubscriberDocument = gql`
    mutation createSubscriber($name: String!, $email: String!, $phone: String!, $message: String!) {
  createSubscriber(
